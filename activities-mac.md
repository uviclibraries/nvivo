...
1.  ***Creating a project and navigating the workspace***
    ...
    **There are 4 key areas of the NVivo workspace:**
    ...
    <img src="images\mac instructions\menus-overview.png" alt="menus overview" style="width:480px;">
...
2.  ***Importing your files***
    ...
    <img src="images\icon-txt.png" alt="text icon" style="width:90px;">
    <img src="images\icon-aud.png" alt="audio icon" style="width:90px;">
    <img src="images\icon-pdf.png" alt="pdf icon" style="width:90px;">
...
3.  ***Coding text files with nodes***
    ...
    <img src="images\mac instructions\new-node-coding.gif" alt="coding at new node" style="width:480px;">
    <img src="images\mac instructions\new-node-coding.png" alt="menu for coding at new node" style="width:480px;">
    ...
    <img src="images\mac instructions\old-node-coding.gif" alt="coding at existing node" style="width:480px;">
    ...
    <img src="images\mac instructions\multi-themes.gif" alt="coding multiple themes" style="width:480px;">
    ...
    <img src="images\mac instructions\highlighting-code.gif" alt="highlighting code" style="width:480px;">
    ...
    <img src="images\mac instructions\coding-density.gif" alt="coding density" style="width:480px;">
    ...
    <img src="images\mac instructions\uncode-selection.gif" alt="uncode" style="width:480px;">
    ...
    <img src="images\mac instructions\code-hierarchy.gif" alt="coding hierarchy" style="width:480px;">
    ...
    <img src="images\mac instructions\undo-code-hierarchy.gif" alt="undo code hierarchy" style="width:480px;">
    ...
    <img src="images\mac instructions\last-of-step-3.png" alt="complete coded document" style="width:480px;">
...
4.  ***Word frequency queries***
    ...
    <img src="images\word-frequency.png" alt="word frequency query" style="width:480px;">
    ...
    <img src="images\mac instructions\save-query.gif" alt="word frequency query demo" style="width:480px;">
...
5.  ***Text search queries***
    ...
    <img src="images\arduino-icon.png" alt="arduino icon" style="width:480px;">
    ...
    <img src="images\mac instructions\save-text-query.gif" alt="text search query demo" style="width:480px;">
...
6.  ***Matrix coding queries***
    ...
    <img src="images\mac instructions\save-matrix-query.gif" alt="matrix query demo" style="width:480px;">
    <img src="images\mac instructions\matrix-query.gif" alt="matrix query" style="width:480px;">
...
7.  ***Creating visualizations***
    ...
    <img src="images\mac instructions\visualize-query.gif" alt="creating visualizations" style="width:480px;">
