...
<img src="images\mac instructions\new-project.png" alt="create new project" style="float:right;width:240px;">
...
1.  ***Creating a project and navigating the workspace***
    ...
    <img src="images\mac instructions\new-project-menu.png" alt="new project menu" style="float:right;width:240px;">
...
2.  ***Importing your files***
    ...
    **pdf file:**<img src="images\icon-pdf.png" alt="pdf icon" style="width:30px;">
    ...
    <img src="images\mac instructions\import-files.gif" alt="importing files" style="width:720px;">
...
3.  ***Coding text files with nodes***
    ...
    <img src="images\mac instructions\new-node-coding.gif" alt="coding at new node" style="width:720px;">
...
4.  ***Word frequency queries***
    ...
    <img src="images\mac instructions\save-query.gif" alt="word frequency query demo" style="width:720px;">
...
5.  ***Text search queries***
    ...
    <img src="images\mac instructions\save-text-query.gif" alt="text search query demo" style="width:720px;">
...
6.  ***Matrix coding queries***
    ...
    <img src="images\mac instructions\save-matrix-query.gif" alt="matrix query demo" style="width:720px;">
    <img src="images\mac instructions\matrix-query.gif" alt="matrix query" style="width:720px;">
...
7.  ***Creating visualizations***
    ...
    <img src="images\mac instructions\visualize-query.gif" alt="creating visualizations" style="width:720px;">
