...
3. ***Coding text files with nodes***
    ...
    <img src="images\windows instructions\windows-highlight.gif" alt="highlighting" style="width:30px;">
    ...
    <img src="images\windows instructions\windows-codingstripes.gif" alt="coding stripes" style="width:30px;">
    ...
    <img src="images\windows instructions\windows-uncode.gif" alt="uncoding" style="width:30px;">
    ...
    <img src="images\windows instructions\logo.png" alt="coding stripes" style="width:30px;">
