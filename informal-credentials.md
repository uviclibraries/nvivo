...
nav_order: 9
---
<img src="images\badgr-logo.png" alt="badgr nvivo logo" style="float:right;width:180px;">
...
If you’d like to earn a DSC badge for this workshop, please email the following screenshots to: [sharonddias@uvic.ca](mailto:sharonddias@uvic.ca){:target="_blank"}
1.  Coding Book
2.  Word Frequency
3.  A Visualization
